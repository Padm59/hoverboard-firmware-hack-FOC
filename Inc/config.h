...
#define BAT_CALIB_REAL_VOLTAGE  4036      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
#define BAT_CALIB_ADC           1581      // adc-value measured by mainboard (value nr 5 on UART debug output)
...
#define BAT_DEAD                (295 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // All leds off: undervoltage poweroff. (while not driving) [V*100/cell]. In this case 3.37 V/cell
// ######################## END OF BATTERY ###############################
...
// Limitation settings
#define I_MOT_MAX       10              // [A] Maximum single motor current limit 1.Mai 7A und 9A
...
#define N_MOT_MAX       200            // [rpm] Maximum motor speed limit 100 1.Mai, 600->18,6km/h, 100->3,1km/h, 200->6,2km/h, 300->9,3km/h, 400->12,4km/h, 500->15,5km/h
...
*/
// Value of RATE is in fixdt(1,16,4): VAL_fixedPoint = VAL_floatingPoint * 2^4. In this case 480 = 30 * 2^4 //TODO:Passend einstellen
#define DEFAULT_RATE                150   // 30.0f [-] lower value == slower rate [0, 32767] = [0.0, 2047.9375]. Do NOT make rate negative (>32767) //480 Default //150 1.Mai //70 am 8.03.26
#define DEFAULT_FILTER              3200  // Default for FILTER 0.1f [-] lower value == softer filter [0, 65535] = [0.0 - 1.0]. //1000 1.Mai
...
#define DEFAULT_STEER_COEFFICIENT   3200  // Defualt for STEER_COEFFICIENT 0.5f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case  8192 = 0.5 * 2^14. If you do not want any steering, set it to 0.
